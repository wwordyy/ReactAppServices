...
export async function patchAddDefaultAdress(data) {

  const response = await fetch(`${API_USERS}/defaultAddress`, {
    method: 'PATCH',
    headers: { 'Content-type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export async function patchDellDefaultAdress(userID) {
